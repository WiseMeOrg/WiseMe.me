    ...
    <div className="mt-20 px-4 sm:px-8">
      ...
      >
        ...
        >
          {/* Heading */}
          <motion.h1
            className="text-5xl sm:text-7xl md:text-9xl font-bold text-[#6EC1E4] tracking-wider text-center"
          ...
          <motion.h1
            className="text-5xl sm:text-7xl md:text-9xl font-bold text-[#6EC1E4] tracking-wider mt-4 text-center"
            initial={{ letterSpacing: "0.01em", y: 20, opacity: 0 }}
            animate={{ letterSpacing: "0.01em", y: 0, opacity: 1 }}
          ...
          <motion.div
            ...
            className="h-[2px] bg-[#6EC1E4]/30 mt-8"
          />
        </motion.div>
      </motion.div>
    </div>
