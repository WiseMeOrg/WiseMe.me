                ...
                {PLANS.map((plan) => (
                    <Card
                        ...
                        className={cn(
                            ...
                            plan.name === "Pro" && "border-2 border-[#6EC1E4]"
                        )}
                    >
                        <CardHeader className={cn(
                            "border-b border-border",
                            plan.name === "Pro" ? "bg-[#6EC1E4]/[0.07]" : "bg-foreground/[0.03]"
                        )}>
                        ...
                        <CardFooter className="w-full mt-auto">
                            <Link
                                href={plan.btn.href}
                                style={{ width: "100%" }}
                                className={buttonVariants({ className: plan.name === "Pro" && "bg-[#6EC1E4] hover:bg-[#6EC1E4]/80 text-white" })}
                            >
                                {plan.btn.text}
                            </Link>
                        </CardFooter>
